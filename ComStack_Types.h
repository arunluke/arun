...
typedef struct  PduInfoType                                    /* STORE THE BASIC INFORMATION ABOUT PDU*/
{
...
typedef enum   BufReq_ReturnType                                     /*  Store the result of a buffer request*/
{
...
typedef enum TpDataStateType                                       /* Store the state of TP buffer */
{
	TP_DATACONF=0x00 ,
	TP_DATARETRY=0x01 ,
	TP_CONFPENDING=0x02,
